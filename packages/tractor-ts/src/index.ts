...
import { NormalisedNode, Signature } from "./lib/graph-normalizer.js";
import { PluginHost, PluginState, PluginTrustGrant } from "./lib/plugin-host.js";
...
export class Tractor {
	...
	async spawnChild(
		namespace: string,
		configOverrides: Partial<TractorConfig> = {},
	): Promise<Tractor> {
