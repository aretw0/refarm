...
- `src/provider_runtime.rs` — provider loop helpers (max iter, loop termination, error extraction, tool dispatch dedup, argument parse, usage aggregation, executed-call shaping)
