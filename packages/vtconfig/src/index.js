...
export function getAliases(root) {
  ...
  return {
    ...
    '@refarm.dev/storage-sqlite/node': path.resolve(packagesDir, 'storage-sqlite', useDistGlobal || forcedDistPackages.includes('@refarm.dev/storage-sqlite') ? 'dist/node.js' : 'src/node.ts'),
