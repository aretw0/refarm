...
import { SLOTS, TYPE_VOCAB, TYPE_VOCAB_MAX, N_X } from "./schema-slots";
...
export class StructAwareEncoder implements ObsEncoder {
	...
	private encodeRelational(vec: Float32Array, node: NormalisedNodeLike | null | undefined): void {
 ...
 */
function hashIntoSlot(vec: Float32Array, offset: number, width: number, input: string): void {
	// FNV-1a 32-bit
	let hash = 0x811c9dc5;
