...
fn is_forwardable_llm_env_key(key: &str) -> bool {
    ...
    !(upper.ends_with("_API_KEY")
        ...
        || upper.contains("_GITHUBTOKEN_")
        || upper.ends_with("_GITHUBPAT")
        || upper.contains("_GITHUBPAT_")
        || upper.ends_with("_GITLABTOKEN")
        || upper.contains("_GITLABTOKEN_")
        || upper.ends_with("_GITLABPRIVATETOKEN")
        || upper.contains("_GITLABPRIVATETOKEN_")
        || upper.ends_with("_GITLABCITOKEN")
        || upper.contains("_GITLABCITOKEN_")
        || upper.ends_with("_GITLABWEBHOOKSECRETTOKEN")
        || upper.contains("_GITLABWEBHOOKSECRETTOKEN_")
        || upper.ends_with("_BITBUCKETTOKEN")
        || upper.contains("_BITBUCKETTOKEN_")
        || upper.ends_with("_BITBUCKETAPPPASSWORD")
        || upper.contains("_BITBUCKETAPPPASSWORD_")
        || upper.ends_with("_SLACKBOTTOKEN")
        || upper.contains("_SLACKBOTTOKEN_")
        || upper.ends_with("_SLACKAPPTOKEN")
        || upper.contains("_SLACKAPPTOKEN_")
        || upper.ends_with("_DISCORDTOKEN")
        || upper.contains("_DISCORDTOKEN_")
        || upper.ends_with("_STRIPEAPIKEY")
        || upper.contains("_STRIPEAPIKEY_")
        || upper.ends_with("_STRIPESECRETKEY")
        || upper.contains("_STRIPESECRETKEY_")
        ...
        || upper.contains("_SLACKWEBHOOKURL_")
        || upper.ends_with("_DISCORDWEBHOOKURL")
        || upper.contains("_DISCORDWEBHOOKURL_")
        || upper.ends_with("_STRIPEWEBHOOKSECRET")
        || upper.contains("_STRIPEWEBHOOKSECRET_")
        || upper.ends_with("_SLACKSIGNINGSECRET")
        || upper.contains("_SLACKSIGNINGSECRET_")
        ...
        || upper.contains("_SLACKSIGNATURE_")
        || upper.ends_with("_SLACKREQUESTTIMESTAMP")
        || upper.contains("_SLACKREQUESTTIMESTAMP_")
        || upper.ends_with("_STRIPESIGNATURE")
        || upper.contains("_STRIPESIGNATURE_")
        ...
        || upper.contains("_CFACCESSJWTASSERTION_")
        || upper.ends_with("_GOOGIAPJWTASSERTION")
        || upper.contains("_GOOGIAPJWTASSERTION_")
        ...
        || upper.contains("_GITLABUSERID_")
        || upper.ends_with("_GITLABUSERNAME")
        || upper.contains("_GITLABUSERNAME_")
        || upper.ends_with("_GITLABUSERLOGIN")
        || upper.contains("_GITLABUSERLOGIN_")
        || upper.ends_with("_GITLABUSEREMAIL")
        || upper.contains("_GITLABUSEREMAIL_")
        ...
        || upper.contains("_GITHUBUSERID_")
        || upper.ends_with("_GITHUBLOGIN")
        || upper.contains("_GITHUBLOGIN_")
        || upper.ends_with("_GITHUBUSEREMAIL")
        || upper.contains("_GITHUBUSEREMAIL_")
        ...
        || upper.contains("_BITBUCKETUSER_")
        || upper.ends_with("_BITBUCKETUUID")
        || upper.contains("_BITBUCKETUUID_")
        || upper.ends_with("_BITBUCKETUSEREMAIL")
        || upper.contains("_BITBUCKETUSEREMAIL_")
        ...
        || upper.contains("_CFACCESSCLIENTID_")
        || upper.ends_with("_CFACCESSCLIENTSECRET")
        || upper.contains("_CFACCESSCLIENTSECRET_")
        || upper.ends_with("_CLOUDFLAREACCESSCLIENTID")
        || upper.contains("_CLOUDFLAREACCESSCLIENTID_")
        || upper.ends_with("_CLOUDFLAREACCESSCLIENTSECRET")
        || upper.contains("_CLOUDFLAREACCESSCLIENTSECRET_")
        ...
        || upper.contains("_KUBECONFIGPATH_")
