...
fn is_forwardable_llm_env_key(key: &str) -> bool {
    ...
    !(upper.ends_with("_API_KEY")
        ...
        || upper.contains("_AUTHORIZATIONHEADER_")
        || upper.contains("_AUTHORIZATION_")
        || upper.ends_with("_BEARER")
        || upper.contains("_BEARER_")
