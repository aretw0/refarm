    ...
    async fn spawn_rejects_runtime_injection_env_keys() {
        ...
        let cases = [
            ...
            ("SERVICE_CABUNDLE", "/tmp/evil-service-ca.pem"),
            ("SERVICE_CA_FILE", "/tmp/evil-service-ca-file.pem"),
            ("SERVICE_CAFILE", "/tmp/evil-service-ca-file.pem"),
            ("SERVICE_CA_PATH", "/tmp/evil-service-ca-dir"),
            ("SERVICE_CAPATH", "/tmp/evil-service-ca-dir"),
            ...
            ("SERVICE_PROXYURL", "http://127.0.0.1:9999"),
            ("SERVICE_NO_PROXY", "localhost,127.0.0.1"),
            ("SERVICE_NOPROXY", "localhost,127.0.0.1"),
            ("SERVICE_NETRC", "/tmp/evil-service.netrc"),
            ("SERVICE_WGETRC", "/tmp/evil-service.wgetrc"),
            ("SERVICE_PROXY_AUTHORIZATION", "Basic ZXZpbA=="),
            ("SERVICE_PROXYAUTHORIZATION", "Basic ZXZpbA=="),
            ("SERVICE_PROXY_STATUS", "error=http_request_error"),
            ("SERVICE_PROXYSTATUS", "error=http_request_error"),
            ("SERVICE_PROXYCONNECTION", "keep-alive"),
            ("SERVICE_AUTHENTICATIONINFO", "nextnonce=abc"),
            ("SERVICE_UPGRADE", "websocket"),
            ("SERVICE_KEEP_ALIVE", "timeout=5"),
            ("SERVICE_KEEPALIVE", "timeout=5"),
            ...
            ("SERVICE_SSLCLIENTDN", "CN=alice"),
            ("SERVICE_SSLCLIENTVERIFY", "SUCCESS"),
            ("SERVICE_CLIENTCERTCHAIN", "cert1,cert2"),
            ("SERVICE_CLIENTDN", "CN=alice"),
            ("SERVICE_CLIENTSAN", "alice.example"),
            ("SERVICE_CLIENTVERIFY", "SUCCESS"),
            ("SERVICE_PRIVATEKEY", "-----BEGIN PRIVATE KEY-----..."),
            ...
            ("SERVICE_CLIENTPRINCIPALID", "alice-id"),
            ("SERVICE_CLIENTPRINCIPALNAME", "alice"),
            ("PRINCIPAL_ID", "alice-id"),
            ("SERVICE_PRINCIPALID", "alice-id"),
            ("SERVICE_PRINCIPALNAME", "alice"),
            ...
            ("SERVICE_GITHUBTOKEN", "ghp_eviltoken"),
            ("gh_token", "gho_eviltoken"),
            ("GH_ENTERPRISE_TOKEN", "ghes-eviltoken"),
            ("GITHUB_PAT", "github-pat-evil"),
            ("SERVICE_GITHUBPAT", "github-pat-evil"),
            ("GITLAB_TOKEN", "glpat-eviltoken"),
            ("SERVICE_GITLABTOKEN", "glpat-eviltoken"),
            ("GITLAB_PRIVATE_TOKEN", "glpat-private-evil"),
            ("SERVICE_GITLABPRIVATETOKEN", "glpat-private-evil"),
            ("GITLAB_CI_TOKEN", "gitlab-ci-token"),
            ("SERVICE_GITLABCITOKEN", "gitlab-ci-token"),
            ...
            ("SERVICE_GITLABUSERID", "123"),
            ("SERVICE_GITLABUSERNAME", "evil-user"),
            ("SERVICE_GITLABUSERLOGIN", "evil-user"),
            ("SERVICE_GITLABUSEREMAIL", "evil@example.com"),
            ("SERVICE_GITHUBUSERID", "123"),
            ("SERVICE_GITHUBLOGIN", "evil-user"),
            ("SERVICE_GITHUBUSEREMAIL", "evil@example.com"),
            ...
            ("SERVICE_AMZNOIDCACCESSTOKEN", "amzn-oidc-access-token-evil"),
            ("JWT_ASSERTION", "eyJhbGciOiJSUzI1NiJ9.evil.assertion"),
            ("OIDC_USERINFO", "alice@example.com"),
            ("AUTH_SESSION_ID", "session-id-evil"),
            ("SERVICE_SESSIONID", "session-id-evil"),
            ("USER_SESSION", "session-evil"),
            ("SERVICE_TLS_INSECURE", "true"),
            ("SERVICE_TLSINSECURE", "true"),
            ("SERVICE_VERIFY_SSL", "false"),
            ("SERVICE_VERIFYSSL", "false"),
            ("SERVICE_SSL_VERIFY", "0"),
            ("SERVICE_SSLVERIFY", "0"),
            ("SERVICE_URL_SCHEME", "http"),
            ("SERVICE_URLSCHEME", "http"),
            ("SERVICE_REQUESTTIMESTAMP", "1711111111"),
            ("SERVICE_HTTP_METHOD_OVERRIDE", "GET"),
            ("SERVICE_HTTPMETHODOVERRIDE", "GET"),
            ("SERVICE_METHOD_OVERRIDE", "GET"),
            ("SERVICE_METHODOVERRIDE", "GET"),
            ("SERVICE_FORWARDED_METHOD", "GET"),
            ("SERVICE_FORWARDEDMETHOD", "GET"),
            ("SERVICE_ORIGINAL_METHOD", "GET"),
            ("SERVICE_ORIGINALMETHOD", "GET"),
            ("SERVICE_ORIGINAL_PATH", "/admin"),
            ("SERVICE_ORIGINAL_URL", "/admin"),
            ("SERVICE_ORIGINALURL", "/admin"),
            ("SERVICE_ORIGINALURI", "/admin"),
            ("SERVICE_ORIGINALPATH", "/admin"),
            ("SERVICE_FORWARDED_PROTO", "http"),
            ("SERVICE_FORWARDED_PROTOCOL", "http"),
            ("SERVICE_FORWARDED_PORT", "443"),
            ("SERVICE_FORWARDED_PREFIX", "/internal"),
            ("SERVICE_FORWARDED_SERVER", "edge-1"),
            ("SERVICE_FORWARDED_SSL", "on"),
            ("SERVICE_ORIGINAL_FORWARDED_HOST", "evil.example"),
            ("SERVICE_ORIGINAL_FORWARDED_PROTO", "http"),
            ("SERVICE_ORIGINAL_FORWARDED_PORT", "443"),
            ("SERVICE_ORIGINAL_HOST", "evil.example"),
            ("SERVICE_FORWARDEDURI", "/admin"),
            ("SERVICE_REWRITE_URL", "/admin"),
            ("SERVICE_REWRITEURL", "/admin"),
            ("SERVICE_REWRITEURI", "/admin"),
            ("SERVICE_ENVOYORIGINALPATH", "/admin"),
            ("SERVICE_ENVOYORIGINALURL", "/admin"),
            ("SERVICE_REAL_IP", "1.2.3.4"),
            ("SERVICE_REALIP", "1.2.3.4"),
            ("SERVICE_CLIENTIP", "1.2.3.4"),
            ("SERVICE_TRUECLIENTIP", "1.2.3.4"),
            ("SERVICE_CF_CONNECTING_IP", "1.2.3.4"),
            ("SERVICE_CFCONNECTINGIP", "1.2.3.4"),
            ("SERVICE_CLUSTERCLIENTIP", "1.2.3.4"),
            ("SERVICE_ENVOYEXTERNALADDRESS", "1.2.3.4"),
            ("SERVICE_ENVOY_PEER_METADATA", "peer-data"),
            ("SERVICE_ENVOYPEERMETADATA", "peer-data"),
            ("SERVICE_ENVOYPEERMETADATAID", "sidecar~id"),
            ("SLACK_REQUEST_TIMESTAMP", "1711111111"),
            ("SERVICE_SLACKREQUESTTIMESTAMP", "1711111111"),
            (
            ...
            ("SERVICE_BITBUCKETTOKEN", "bb-token"),
            ("BITBUCKET_APP_PASSWORD", "bb-app-password"),
            ("SERVICE_BITBUCKETAPPPASSWORD", "bb-app-password"),
            ("BITBUCKET_WORKSPACE", "evil-workspace"),
            ("SERVICE_BITBUCKETUSER", "evil-user"),
            ("SERVICE_BITBUCKETUUID", "uuid-evil"),
            ("SERVICE_BITBUCKETUSEREMAIL", "evil@example.com"),
            ...
            ("SERVICE_ACCESSKEY", "service-access-key-evil"),
            ("SERVICE_SIGNINGKEY", "service-signing-key-evil"),
            ...
            ("SERVICE_SUPABASEDBURL", "postgres://user:pass@db/supabase"),
            ...
            (
                "SERVICE_METABASEDBCONNECTIONURI",
                "postgres://user:pass@db/metabase",
            ),
            (
            ...
            ("SERVICE_STRIPEAPIKEY", "stripe-api-key-evil"),
            ("stripe_secret_key", "stripe-secret-key-evil"),
            ("SERVICE_STRIPESECRETKEY", "stripe-secret-key-evil"),
            ("STRIPE_WEBHOOK_SECRET", "whsec_evil_secret"),
            ("SERVICE_STRIPEWEBHOOKSECRET", "whsec_evil_secret"),
            ("SERVICE_WEBHOOKSECRET", "whsec_evil_secret"),
            ...
            ("SERVICE_WEBHOOKURL", "https://hooks.example/evil"),
            (
                "CUSTOM_WEBHOOK_SECRET_TOKEN",
                "custom-webhook-secret-token-evil",
            ),
            (
                "SERVICE_WEBHOOKSECRETTOKEN",
                "custom-webhook-secret-token-evil",
            ),
            ("PAYLOAD_SIGNATURE", "sha256=deadbeef"),
            ("SERVICE_STRIPESIGNATURE", "sha256=deadbeef"),
            ("SERVICE_SIGNATURETIMESTAMP", "1711111111"),
            ("SERVICE_HMACSHA256", "deadbeef"),
            ...
            ("SERVICE_DISCORDTOKEN", "discord-token-evil"),
            (
                "DISCORD_WEBHOOK_URL",
                "https://discord.com/api/webhooks/evil",
            ),
            (
                "SERVICE_DISCORDWEBHOOKURL",
                "https://discord.com/api/webhooks/evil",
            ),
            ("DISCORD_APPLICATION_ID", "123456789012345678"),
            ("SLACK_BOT_TOKEN", "xoxb-evil-token"),
            ("SERVICE_SLACKBOTTOKEN", "xoxb-evil-token"),
            ("SLACK_APP_TOKEN", "xapp-evil-token"),
            ("SERVICE_SLACKAPPTOKEN", "xapp-evil-token"),
            ("slack_signing_secret", "slack-signing-secret-evil"),
            ("SERVICE_SLACKSIGNINGSECRET", "slack-signing-secret-evil"),
            ("SERVICE_SLACKSIGNATURE", "v0=deadbeef"),
            ("SLACK_WEBHOOK_URL", "https://hooks.slack.com/services/evil"),
            ("SERVICE_SLACKWEBHOOKURL", "https://hooks.slack.com/services/evil"),
            ...
            ("SERVICE_DATABASEURL", "postgres://user:pass@db/evil"),
            ("DATABASE_HOST", "db.evil"),
            ("database_dsn", "postgres://user:pass@db/evil"),
            ("SERVICE_DATABASEDSN", "postgres://user:pass@db/evil"),
            ("REDIS_URL", "redis://:pass@redis:6379/0"),
            ("SERVICE_REDISURL", "redis://:pass@redis:6379/0"),
            ("REDIS_HOST", "redis.evil"),
            ("mongodb_uri", "mongodb://user:pass@mongo:27017/evil"),
            ("SERVICE_MONGODBURI", "mongodb://user:pass@mongo:27017/evil"),
            ("MONGODB_DBNAME", "evil"),
            ("POSTGRES_URL", "postgres://user:pass@db/evil"),
            ("SERVICE_POSTGRESURL", "postgres://user:pass@db/evil"),
            (
            ...
            ("SERVICE_MYSQLURL", "mysql://user:pass@db/evil"),
            ...
            ("SERVICE_IDENTITYENDPOINT", "http://127.0.0.1:40342/msi/token"),
            ("identity_header", "secret-identity-header"),
            ("SERVICE_IDENTITYHEADER", "secret-identity-header"),
            ("IMDS_ENDPOINT", "http://169.254.169.254/metadata/identity"),
            ("SERVICE_IMDSENDPOINT", "http://169.254.169.254/metadata/identity"),
            ("MSI_ENDPOINT", "http://127.0.0.1:40342/msi/token"),
            ("SERVICE_MSIENDPOINT", "http://127.0.0.1:40342/msi/token"),
            ...
            ("SERVICE_KUBECONFIGPATH", "/tmp/evil-kubeconfig"),
            ...
            ("SERVICE_K8SAWSID", "evil-k8s-aws-id"),
