...
/// SOVEREIGN_CONFIG_DIR (injected by the app). These tests write their fixture under
...
fn ensure_config_dir_env() {
    use std::sync::Once;
    static SET: Once = Once::new();
    SET.call_once(|| std::env::set_var("SOVEREIGN_CONFIG_DIR", ".refarm"));
}
