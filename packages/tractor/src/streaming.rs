...
mod tests {
    ...
    fn stream_observation_labels_are_stable() {
        ...
        assert_eq!(STREAM_CHUNK_PAYLOAD_KIND_TEXT_DELTA, "text_delta");
        assert_eq!(STREAM_CHUNK_PAYLOAD_KIND_FINAL_TEXT, "final_text");
        assert_eq!(STREAM_CHUNK_PAYLOAD_KIND_FINAL_TOOL_CALL, "final_tool_call");
        assert_eq!(STREAM_CHUNK_PAYLOAD_KIND_FINAL_EMPTY, "final_empty");
    }
}
