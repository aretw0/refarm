...
export const WORKSPACE_NAMESPACE_ACCESS = Object.freeze(["readOnly", "readWrite", "generated"]);
...
export function declaredWorkspaceNamespaceFromConfig(config, namespacePath, options = {}) {
	...
	return (
		declaredWorkspaceNamespacesFromConfig(config, options).find(
			(namespace) => namespace.path === normalizedPath,
		) ?? null
	);
}
