...
export const ENVIRONMENT_CEILING_SLICE_KINDS = Object.freeze(["control", "workload", "agent"]);
...
function normalizeHeavyLanePolicy(value) {
	...
	return {
		strictPressureGate:
			policy.strictPressureGate === undefined ? false : Boolean(policy.strictPressureGate),
