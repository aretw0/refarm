...
| Recover from failure      | Operator recovery kit - spec drafted: `specs/features/2026-07-03-recovery-kit.md` | restore from backup without graph corruption or lost tasks                                                                                      | ⬜     |
| Automate reminders        | automation-contract-v1 + windmill/local-scheduler + `.refarm` ledger + project automation trigger adapter shipped; farmhand tick still pending — spec: `specs/features/2026-07-03-local-reminders-execution.md` | one-shot and recurring reminders run locally with clear ownership                                                                               | ⬜     |
