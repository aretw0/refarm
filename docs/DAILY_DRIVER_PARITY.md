...
| Recover from failure      | SQLite/OPFS backup path — spec drafted: `specs/features/2026-07-03-operator-state-backup-restore.md` | restore from backup without graph corruption or lost tasks                                                                                      | ⬜     |
| Automate reminders        | automation-contract-v1 + windmill/local-scheduler + farmhand tick — spec drafted: `specs/features/2026-07-03-local-reminders-execution.md` | one-shot and recurring reminders run locally with clear ownership                                                                               | ⬜     |
