...
| Automate reminders        | automation-contract-v1 + windmill/local-scheduler + `.refarm` ledger shipped; farmhand tick still pending — spec: `specs/features/2026-07-03-local-reminders-execution.md` | one-shot and recurring reminders run locally with clear ownership                                                                               | ⬜     |
