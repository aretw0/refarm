...
| 4c `silo` collect | **implemented** | contract boundary, namespaces, namespaced secret store, app re-export, acceptance wiring, Silo v0.1.1 bulk storage helpers and light-by-default storage closure | official storage adoption by `vault-seed` remains item 8a |
