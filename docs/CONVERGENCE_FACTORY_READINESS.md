...
- `native:skills:dgk-vault-search-smoke` composes the reviewed `vault-seed`
  ...
  `source:v1` checkout status call, and receipt without installing, copying,
  vendoring, executing the external skill, or executing `dgk`/Obsidian product
  commands;
