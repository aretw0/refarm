...
| 4a `ds` tokens | **implemented + downstream-proven** | contract, scoped tokens, 4 themes, theme-conformance, component classes, CSS exports, and quality adapter; focused package gate re-verified 2026-06-26; official downstream proof received through the 2026-07-03 `vault-seed-ready` handoff | broad steward/push gate and public publication still wait on release lane |
| 4b `ds/html` | **implemented + downstream-proven** | DS-owned helper API, build-free boundary, consumer proof, package files constraint, and official downstream site/admin proof through the 2026-07-03 `vault-seed-ready` handoff | public publication still waits on release lane |
