...
- **[Dispatch Control Plane Contract](superpowers/specs/2026-06-17-dispatch-control-plane-contract.md)** — Shared transport envelope and channel-effort semantics for CLI/daemon/client stacks.
