...
| 4 | agents-lab bridge | `docs/superpowers/specs/2026-05-14-agents-lab-portability.md` | in progress | build the **policy envelope** + **invocation adapter** (skill-contract + capability already exist) |
