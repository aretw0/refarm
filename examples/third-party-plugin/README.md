...
- Contract packages: use your workspace `packages` directory
- Plugin developer guide: see local project documentation under `docs/`
- ADR-018: Capability contracts and observability gates (project ADRs under `specs/ADRs/`)
