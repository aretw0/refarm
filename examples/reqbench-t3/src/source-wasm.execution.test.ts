...
const artifactsReady =
	existsSync(BINARY) && existsSync(SOURCE_WASM) && existsSync(SOURCE_MANIFEST);
...
describe.skipIf(!enabled)("reqbench T3 — source as a loaded WASM plugin (extend, not import)", () => {
