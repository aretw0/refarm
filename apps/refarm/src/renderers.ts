...
export const REFARM_WEB_RENDERER = createHomesteadHostRendererDescriptor("refarm-web", "web");

export const REFARM_TUI_RENDERER = createHomesteadHostRendererDescriptor("refarm-tui", "tui");
...
export const REFARM_RENDERERS: Record<HomesteadHostRendererKind, HomesteadHostRendererDescriptor> =
	{
