...
export const LOCAL_MODEL_JSON_COMMAND = refarmCommand([
	"sow",
	"--model",
	OLLAMA_DEFAULT_REF,
	"--json",
]);
export const OPENAI_MODEL_JSON_COMMAND = refarmCommand(["model", OPENAI_DEFAULT_REF, "--json"]);
export const OPENAI_WORKER_MODEL_JSON_COMMAND = refarmCommand([
	"model",
	"set",
	"--scope",
	"worker",
...
export const OPENAI_MONITOR_MODEL_JSON_COMMAND = refarmCommand([
	"model",
	"set",
	"--scope",
	"monitor",
