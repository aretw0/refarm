...
The canonical protocol definition is extracted from `apps/farmhand/src/transports/http.ts` (`SidecarAdapter` interface + `HttpSidecar` route table) and mirrored as OpenAPI in `specs/openapi/farmhand-sidecar.v1.json`.
