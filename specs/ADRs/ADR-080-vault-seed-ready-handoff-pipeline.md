...
the `vault-seed-ready` release-policy selection (currently 20 packages tagged in
...
- `.refarm/handoff/vault-seed/2026-07-03/manifest.json` (current accepted packet: 20 packages,
  58 required checks, `acceptance.status: "accepted"`)
