...
**Related**: [ADR-045 — Loro CRDT Adoption](ADR-045-loro-crdt-adoption.md), [ADR-015 — SQLite Engine Decision](ADR-015-sqlite-engine-decision.md), ADR-091 (Tractor runtime saga)  
