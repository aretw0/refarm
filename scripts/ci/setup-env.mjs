...
import { SiloCore } from "../../packages/silo/src/index.js";
...
function collectScopes(rootDir, config) {
	...
	const derivedScopes = {
		...
		farmhand: readPackageScope(
			path.join(rootDir, "apps/farmhand/package.json"),
		),
	};

	return { ...configuredScopes, ...derivedScopes };
}
