...
import { validateTextQualityConfig } from "./text-quality-config-schema.mjs";

export { validateTextQualityConfig } from "./text-quality-config-schema.mjs";
...
export async function loadTextQualityConfig(configPath) {
	...
	try {
		...
		if (cause?.code === "ERR_TEXT_QUALITY_CONFIG_SCHEMA") throw cause;
